...
// BookingTokenTokenReservation is an auto generated low-level Go binding around an user-defined struct.
type BookingTokenTokenReservation struct {
...
func bindBookingtokenv2(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(Bookingtokenv2ABI))
	if err != nil {
		return nil, err
	}
...
func (_Bookingtokenv2 *Bookingtokenv2Caller) NATIVEPAYMENT(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bookingtokenv2.contract.Call(opts, &out, "NATIVE_PAYMENT")
...
//
// Solidity: function NATIVE_PAYMENT() view returns(address)
func (_Bookingtokenv2 *Bookingtokenv2Session) NATIVEPAYMENT() (common.Address, error) {
	return _Bookingtokenv2.Contract.NATIVEPAYMENT(&_Bookingtokenv2.CallOpts)
}

// NATIVEPAYMENT is a free data retrieval call binding the contract method 0xa0f07c74.
//
// Solidity: function NATIVE_PAYMENT() view returns(address)
func (_Bookingtokenv2 *Bookingtokenv2CallerSession) NATIVEPAYMENT() (common.Address, error) {
	return _Bookingtokenv2.Contract.NATIVEPAYMENT(&_Bookingtokenv2.CallOpts)
}
...
func (_Bookingtokenv2 *Bookingtokenv2Caller) OFFCHAINPAYMENT(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bookingtokenv2.contract.Call(opts, &out, "OFFCHAIN_PAYMENT")
...
//
// Solidity: function OFFCHAIN_PAYMENT() view returns(address)
func (_Bookingtokenv2 *Bookingtokenv2Session) OFFCHAINPAYMENT() (common.Address, error) {
	return _Bookingtokenv2.Contract.OFFCHAINPAYMENT(&_Bookingtokenv2.CallOpts)
}

// OFFCHAINPAYMENT is a free data retrieval call binding the contract method 0xbfb26c06.
//
// Solidity: function OFFCHAIN_PAYMENT() view returns(address)
func (_Bookingtokenv2 *Bookingtokenv2CallerSession) OFFCHAINPAYMENT() (common.Address, error) {
	return _Bookingtokenv2.Contract.OFFCHAINPAYMENT(&_Bookingtokenv2.CallOpts)
}
...
//
// Solidity: function getCancellationProposalStatus(uint256 tokenId) view returns(uint256 refundAmount, address proposedBy, uint8 status, uint16 cancellationReason, uint16 cancellationReasonVersion, uint16 rejectionReason, uint16 rejectionReasonVersion)
func (_Bookingtokenv2 *Bookingtokenv2Caller) GetCancellationProposalStatus(opts *bind.CallOpts, tokenId *big.Int) (struct {
	...
	outstruct.CancellationReason = *abi.ConvertType(out[3], new(uint16)).(*uint16)
	outstruct.CancellationReasonVersion = *abi.ConvertType(out[4], new(uint16)).(*uint16)
	outstruct.RejectionReason = *abi.ConvertType(out[5], new(uint16)).(*uint16)
	outstruct.RejectionReasonVersion = *abi.ConvertType(out[6], new(uint16)).(*uint16)
...
// GetTokenReservation is a free data retrieval call binding the contract method 0xa6dbb9cb.
//
// Solidity: function getTokenReservation(uint256 tokenId) view returns((address,address,uint256,uint256,address))
func (_Bookingtokenv2 *Bookingtokenv2Caller) GetTokenReservation(opts *bind.CallOpts, tokenId *big.Int) (BookingTokenTokenReservation, error) {
	var out []interface{}
	err := _Bookingtokenv2.contract.Call(opts, &out, "getTokenReservation", tokenId)

	if err != nil {
		return *new(BookingTokenTokenReservation), err
	}

	out0 := *abi.ConvertType(out[0], new(BookingTokenTokenReservation)).(*BookingTokenTokenReservation)
...
//
// Solidity: function getTokenReservation(uint256 tokenId) view returns((address,address,uint256,uint256,address))
func (_Bookingtokenv2 *Bookingtokenv2Session) GetTokenReservation(tokenId *big.Int) (BookingTokenTokenReservation, error) {
	return _Bookingtokenv2.Contract.GetTokenReservation(&_Bookingtokenv2.CallOpts, tokenId)
}

// GetTokenReservation is a free data retrieval call binding the contract method 0xa6dbb9cb.
//
// Solidity: function getTokenReservation(uint256 tokenId) view returns((address,address,uint256,uint256,address))
func (_Bookingtokenv2 *Bookingtokenv2CallerSession) GetTokenReservation(tokenId *big.Int) (BookingTokenTokenReservation, error) {
	return _Bookingtokenv2.Contract.GetTokenReservation(&_Bookingtokenv2.CallOpts, tokenId)
}
...
func (_Bookingtokenv2 *Bookingtokenv2Transactor) InitiateCancellationProposal(opts *bind.TransactOpts, tokenId *big.Int, refundAmount *big.Int, cancellationReason uint16, cancellationReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.contract.Transact(opts, "initiateCancellationProposal", tokenId, refundAmount, cancellationReason, cancellationReasonVersion)
}

// InitiateCancellationProposal is a paid mutator transaction binding the contract method 0xb47177a1.
//
// Solidity: function initiateCancellationProposal(uint256 tokenId, uint256 refundAmount, uint16 cancellationReason, uint16 cancellationReasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2Session) InitiateCancellationProposal(tokenId *big.Int, refundAmount *big.Int, cancellationReason uint16, cancellationReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.InitiateCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, refundAmount, cancellationReason, cancellationReasonVersion)
}

// InitiateCancellationProposal is a paid mutator transaction binding the contract method 0xb47177a1.
//
// Solidity: function initiateCancellationProposal(uint256 tokenId, uint256 refundAmount, uint16 cancellationReason, uint16 cancellationReasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2TransactorSession) InitiateCancellationProposal(tokenId *big.Int, refundAmount *big.Int, cancellationReason uint16, cancellationReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.InitiateCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, refundAmount, cancellationReason, cancellationReasonVersion)
}
...
func (_Bookingtokenv2 *Bookingtokenv2Transactor) ReinitializeV2(opts *bind.TransactOpts, newName string, newSymbol string) (*types.Transaction, error) {
	return _Bookingtokenv2.contract.Transact(opts, "reinitializeV2", newName, newSymbol)
}

// ReinitializeV2 is a paid mutator transaction binding the contract method 0x91da124c.
//
// Solidity: function reinitializeV2(string newName, string newSymbol) returns()
func (_Bookingtokenv2 *Bookingtokenv2Session) ReinitializeV2(newName string, newSymbol string) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.ReinitializeV2(&_Bookingtokenv2.TransactOpts, newName, newSymbol)
}

// ReinitializeV2 is a paid mutator transaction binding the contract method 0x91da124c.
//
// Solidity: function reinitializeV2(string newName, string newSymbol) returns()
func (_Bookingtokenv2 *Bookingtokenv2TransactorSession) ReinitializeV2(newName string, newSymbol string) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.ReinitializeV2(&_Bookingtokenv2.TransactOpts, newName, newSymbol)
}
...
func (_Bookingtokenv2 *Bookingtokenv2Transactor) RejectCancellationProposal(opts *bind.TransactOpts, tokenId *big.Int, rejectionReason uint16, rejectionReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.contract.Transact(opts, "rejectCancellationProposal", tokenId, rejectionReason, rejectionReasonVersion)
}

// RejectCancellationProposal is a paid mutator transaction binding the contract method 0x6872b7e6.
//
// Solidity: function rejectCancellationProposal(uint256 tokenId, uint16 rejectionReason, uint16 rejectionReasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2Session) RejectCancellationProposal(tokenId *big.Int, rejectionReason uint16, rejectionReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.RejectCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, rejectionReason, rejectionReasonVersion)
}

// RejectCancellationProposal is a paid mutator transaction binding the contract method 0x6872b7e6.
//
// Solidity: function rejectCancellationProposal(uint256 tokenId, uint16 rejectionReason, uint16 rejectionReasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2TransactorSession) RejectCancellationProposal(tokenId *big.Int, rejectionReason uint16, rejectionReasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.RejectCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, rejectionReason, rejectionReasonVersion)
}
...
// SafeMintWithReservation0 is a paid mutator transaction binding the contract method 0xdb2b2682.
//
...
func (_Bookingtokenv2 *Bookingtokenv2Transactor) SafeMintWithReservation0(opts *bind.TransactOpts, reservedFor common.Address, uri string, expirationTimestamp *big.Int, price *big.Int, paymentToken common.Address, offchainPaymentCurrency *big.Int, cancellable bool) (*types.Transaction, error) {
	return _Bookingtokenv2.contract.Transact(opts, "safeMintWithReservation0", reservedFor, uri, expirationTimestamp, price, paymentToken, offchainPaymentCurrency, cancellable)
}

// SafeMintWithReservation0 is a paid mutator transaction binding the contract method 0xdb2b2682.
//
// Solidity: function safeMintWithReservation(address reservedFor, string uri, uint256 expirationTimestamp, uint256 price, address paymentToken, uint256 offchainPaymentCurrency, bool cancellable) returns()
func (_Bookingtokenv2 *Bookingtokenv2Session) SafeMintWithReservation0(reservedFor common.Address, uri string, expirationTimestamp *big.Int, price *big.Int, paymentToken common.Address, offchainPaymentCurrency *big.Int, cancellable bool) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.SafeMintWithReservation0(&_Bookingtokenv2.TransactOpts, reservedFor, uri, expirationTimestamp, price, paymentToken, offchainPaymentCurrency, cancellable)
}

// SafeMintWithReservation0 is a paid mutator transaction binding the contract method 0xdb2b2682.
//
// Solidity: function safeMintWithReservation(address reservedFor, string uri, uint256 expirationTimestamp, uint256 price, address paymentToken, uint256 offchainPaymentCurrency, bool cancellable) returns()
func (_Bookingtokenv2 *Bookingtokenv2TransactorSession) SafeMintWithReservation0(reservedFor common.Address, uri string, expirationTimestamp *big.Int, price *big.Int, paymentToken common.Address, offchainPaymentCurrency *big.Int, cancellable bool) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.SafeMintWithReservation0(&_Bookingtokenv2.TransactOpts, reservedFor, uri, expirationTimestamp, price, paymentToken, offchainPaymentCurrency, cancellable)
}
...
func (_Bookingtokenv2 *Bookingtokenv2Transactor) WithdrawCancellationProposal(opts *bind.TransactOpts, tokenId *big.Int, reason uint16, reasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.contract.Transact(opts, "withdrawCancellationProposal", tokenId, reason, reasonVersion)
}

// WithdrawCancellationProposal is a paid mutator transaction binding the contract method 0x6fabeaed.
//
// Solidity: function withdrawCancellationProposal(uint256 tokenId, uint16 reason, uint16 reasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2Session) WithdrawCancellationProposal(tokenId *big.Int, reason uint16, reasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.WithdrawCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, reason, reasonVersion)
}

// WithdrawCancellationProposal is a paid mutator transaction binding the contract method 0x6fabeaed.
//
// Solidity: function withdrawCancellationProposal(uint256 tokenId, uint16 reason, uint16 reasonVersion) returns()
func (_Bookingtokenv2 *Bookingtokenv2TransactorSession) WithdrawCancellationProposal(tokenId *big.Int, reason uint16, reasonVersion uint16) (*types.Transaction, error) {
	return _Bookingtokenv2.Contract.WithdrawCancellationProposal(&_Bookingtokenv2.TransactOpts, tokenId, reason, reasonVersion)
}
...
// Bookingtokenv2CancellationAcceptedByTheOwnerIterator is returned from FilterCancellationAcceptedByTheOwner and is used to iterate over the raw logs and unpacked data for CancellationAcceptedByTheOwner events raised by the Bookingtokenv2 contract.
type Bookingtokenv2CancellationAcceptedByTheOwnerIterator struct {
	Event *Bookingtokenv2CancellationAcceptedByTheOwner // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bookingtokenv2CancellationAcceptedByTheOwnerIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bookingtokenv2CancellationAcceptedByTheOwner)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bookingtokenv2CancellationAcceptedByTheOwnerIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bookingtokenv2CancellationAcceptedByTheOwnerIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bookingtokenv2CancellationAcceptedByTheOwner represents a CancellationAcceptedByTheOwner event raised by the Bookingtokenv2 contract.
type Bookingtokenv2CancellationAcceptedByTheOwner struct {
	TokenId      *big.Int
	AcceptedBy   common.Address
	RefundAmount *big.Int
	Raw          types.Log // Blockchain specific contextual infos
...
// FilterCancellationAcceptedByTheOwner is a free log retrieval operation binding the contract event 0xab9781c7afb2bca22dd3691027e5ef637de104315f60d4d2c4328bc9161c2668.
//
// Solidity: event CancellationAcceptedByTheOwner(uint256 indexed tokenId, address indexed acceptedBy, uint256 refundAmount)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) FilterCancellationAcceptedByTheOwner(opts *bind.FilterOpts, tokenId []*big.Int, acceptedBy []common.Address) (*Bookingtokenv2CancellationAcceptedByTheOwnerIterator, error) {
	...
	logs, sub, err := _Bookingtokenv2.contract.FilterLogs(opts, "CancellationAcceptedByTheOwner", tokenIdRule, acceptedByRule)
	if err != nil {
		return nil, err
	}
	return &Bookingtokenv2CancellationAcceptedByTheOwnerIterator{contract: _Bookingtokenv2.contract, event: "CancellationAcceptedByTheOwner", logs: logs, sub: sub}, nil
}

// WatchCancellationAcceptedByTheOwner is a free log subscription operation binding the contract event 0xab9781c7afb2bca22dd3691027e5ef637de104315f60d4d2c4328bc9161c2668.
//
// Solidity: event CancellationAcceptedByTheOwner(uint256 indexed tokenId, address indexed acceptedBy, uint256 refundAmount)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) WatchCancellationAcceptedByTheOwner(opts *bind.WatchOpts, sink chan<- *Bookingtokenv2CancellationAcceptedByTheOwner, tokenId []*big.Int, acceptedBy []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bookingtokenv2.contract.WatchLogs(opts, "CancellationAcceptedByTheOwner", tokenIdRule, acceptedByRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bookingtokenv2CancellationAcceptedByTheOwner)
				if err := _Bookingtokenv2.contract.UnpackLog(event, "CancellationAcceptedByTheOwner", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCancellationAcceptedByTheOwner is a log parse operation binding the contract event 0xab9781c7afb2bca22dd3691027e5ef637de104315f60d4d2c4328bc9161c2668.
//
// Solidity: event CancellationAcceptedByTheOwner(uint256 indexed tokenId, address indexed acceptedBy, uint256 refundAmount)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) ParseCancellationAcceptedByTheOwner(log types.Log) (*Bookingtokenv2CancellationAcceptedByTheOwner, error) {
	event := new(Bookingtokenv2CancellationAcceptedByTheOwner)
	if err := _Bookingtokenv2.contract.UnpackLog(event, "CancellationAcceptedByTheOwner", log); err != nil {
		return nil, err
	}
...
// FilterCancellationPending is a free log retrieval operation binding the contract event 0x79b98b853a6c04dfc02f383069b458c36ac4135883cdbf149b5aff904078e57c.
//
// Solidity: event CancellationPending(uint256 indexed tokenId, address indexed proposedBy, uint256 refundAmount, uint16 cancellationReason, uint16 cancellationReasonVersion)
...
// WatchCancellationPending is a free log subscription operation binding the contract event 0x79b98b853a6c04dfc02f383069b458c36ac4135883cdbf149b5aff904078e57c.
//
// Solidity: event CancellationPending(uint256 indexed tokenId, address indexed proposedBy, uint256 refundAmount, uint16 cancellationReason, uint16 cancellationReasonVersion)
...
// ParseCancellationPending is a log parse operation binding the contract event 0x79b98b853a6c04dfc02f383069b458c36ac4135883cdbf149b5aff904078e57c.
//
// Solidity: event CancellationPending(uint256 indexed tokenId, address indexed proposedBy, uint256 refundAmount, uint16 cancellationReason, uint16 cancellationReasonVersion)
...
// FilterCancellationRejected is a free log retrieval operation binding the contract event 0x258940b052b1b31e944c2415ac9684f3f5f5e2294871b8956dd432bc7c7edca3.
//
// Solidity: event CancellationRejected(uint256 indexed tokenId, address indexed rejectedBy, uint16 rejectionReason, uint16 rejectionReasonVersion)
...
// WatchCancellationRejected is a free log subscription operation binding the contract event 0x258940b052b1b31e944c2415ac9684f3f5f5e2294871b8956dd432bc7c7edca3.
//
// Solidity: event CancellationRejected(uint256 indexed tokenId, address indexed rejectedBy, uint16 rejectionReason, uint16 rejectionReasonVersion)
...
// ParseCancellationRejected is a log parse operation binding the contract event 0x258940b052b1b31e944c2415ac9684f3f5f5e2294871b8956dd432bc7c7edca3.
//
// Solidity: event CancellationRejected(uint256 indexed tokenId, address indexed rejectedBy, uint16 rejectionReason, uint16 rejectionReasonVersion)
...
// Bookingtokenv2CancellationWithdrawnIterator is returned from FilterCancellationWithdrawn and is used to iterate over the raw logs and unpacked data for CancellationWithdrawn events raised by the Bookingtokenv2 contract.
type Bookingtokenv2CancellationWithdrawnIterator struct {
	Event *Bookingtokenv2CancellationWithdrawn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bookingtokenv2CancellationWithdrawnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bookingtokenv2CancellationWithdrawn)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bookingtokenv2CancellationWithdrawnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bookingtokenv2CancellationWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bookingtokenv2CancellationWithdrawn represents a CancellationWithdrawn event raised by the Bookingtokenv2 contract.
type Bookingtokenv2CancellationWithdrawn struct {
	TokenId       *big.Int
...
// FilterCancellationWithdrawn is a free log retrieval operation binding the contract event 0x13a82951767f2a7efeb88a92151eb59d8be7a42817832b1ba9a8f7d8960c91fb.
//
// Solidity: event CancellationWithdrawn(uint256 indexed tokenId, address indexed cancelledBy, uint16 reason, uint16 reasonVersion)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) FilterCancellationWithdrawn(opts *bind.FilterOpts, tokenId []*big.Int, cancelledBy []common.Address) (*Bookingtokenv2CancellationWithdrawnIterator, error) {
	...
	logs, sub, err := _Bookingtokenv2.contract.FilterLogs(opts, "CancellationWithdrawn", tokenIdRule, cancelledByRule)
	if err != nil {
		return nil, err
	}
	return &Bookingtokenv2CancellationWithdrawnIterator{contract: _Bookingtokenv2.contract, event: "CancellationWithdrawn", logs: logs, sub: sub}, nil
}

// WatchCancellationWithdrawn is a free log subscription operation binding the contract event 0x13a82951767f2a7efeb88a92151eb59d8be7a42817832b1ba9a8f7d8960c91fb.
//
// Solidity: event CancellationWithdrawn(uint256 indexed tokenId, address indexed cancelledBy, uint16 reason, uint16 reasonVersion)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) WatchCancellationWithdrawn(opts *bind.WatchOpts, sink chan<- *Bookingtokenv2CancellationWithdrawn, tokenId []*big.Int, cancelledBy []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Bookingtokenv2.contract.WatchLogs(opts, "CancellationWithdrawn", tokenIdRule, cancelledByRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bookingtokenv2CancellationWithdrawn)
				if err := _Bookingtokenv2.contract.UnpackLog(event, "CancellationWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCancellationWithdrawn is a log parse operation binding the contract event 0x13a82951767f2a7efeb88a92151eb59d8be7a42817832b1ba9a8f7d8960c91fb.
//
// Solidity: event CancellationWithdrawn(uint256 indexed tokenId, address indexed cancelledBy, uint16 reason, uint16 reasonVersion)
func (_Bookingtokenv2 *Bookingtokenv2Filterer) ParseCancellationWithdrawn(log types.Log) (*Bookingtokenv2CancellationWithdrawn, error) {
	event := new(Bookingtokenv2CancellationWithdrawn)
	if err := _Bookingtokenv2.contract.UnpackLog(event, "CancellationWithdrawn", log); err != nil {
		return nil, err
	}
...
//
// Solidity: event TokenReserved(uint256 indexed tokenId, address indexed reservedFor, address indexed supplier, uint256 expirationTimestamp, uint256 price, address paymentToken, uint256 offchainPaymentCurrency, bool isCancellable)
